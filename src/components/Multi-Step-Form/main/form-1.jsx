...
export default function Form1({next, setName, name, setEmail, email, phone, setPhone, nameTrue, emailTrue, phoneTrue}){    
    ...
    return (
        <div className="main-right form-1-main">
            ...
            <div className="form-1-form">
                ...
                <label htmlFor="form-1-name" style={{color: nameTrue ? "black" : "red"}}>Name *</label> <br />
                <input type="text" name="name" id={nameTrue? "form-1-name" : "form-1-name-wrong"} 
                ...
                <label htmlFor="form-1-email" style={{color: emailTrue ? "black" : "red"}}>Email Address *</label> <br />
                ...
                onChange={(e)=> setEmail (e.target.value)} style={{borderColor: emailTrue ? "rgba(49, 46, 46, 0.2)" : "red"}} autoComplete="off"/> <br />
                
                {/* controlled phone number input from "https://www.geeksforgeeks.org/how-to-add-phone-number-input-in-react-js/" */}
                <label htmlFor="form-1-tel" style={{color: phoneTrue ? "black" : "red"}}>Phone Number *</label> <br />
